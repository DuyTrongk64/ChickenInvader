...
SingleGameState::SingleGameState(sf::RenderWindow* window, std::map<std::string, int>* supportedKeys, std::stack<State*>* states, Handler* handler)
...
void SingleGameState::initTextures()
{
...
void SingleGameState::initGUI()
{
	//Load font
	if (!this->font.loadFromFile("Fonts/PixellettersFull.ttf"))
		std::cout << "ERROR::SingleGameState::Failed to load font" << "\n";
...
void SingleGameState::initWorld()
{
	if (!this->worldBackgroundTex.loadFromFile("Textures/background1.jpg"))
	{
		std::cout << "ERROR::SingleGameState::COULD NOT LOAD BACKGROUND TEXTURE" << "\n";
	}

	this->worldBackground.setTexture(this->worldBackgroundTex);
}

void SingleGameState::initSystems()
{
	this->points = 0;
}

void SingleGameState::initPlayer()
{
...
void SingleGameState::initCheckens()
{
	this->spawnTimerMax = 50.f;
	this->spawnTimer = this->spawnTimerMax;
}

void SingleGameState::initckBullets()
{
	this->spawnTimerMax = 50.f;
	this->spawnTimer1 = this->spawnTimerMax;
}
void SingleGameState::initKeybinds()
{
	std::ifstream ifs("Config/SingleGameState_keybinds.ini");
...
void SingleGameState::endState()
{
	std::cout << "End game" << "\n";
}

void SingleGameState::updateKeybinds()
{
	this->checkForQuit();
}

//Functions
void SingleGameState::run()
{
...
void SingleGameState::updateInput()
{
	//Move player
...
void SingleGameState::updateGUI()
{
	std::stringstream ss;
...
void SingleGameState::updateText()
{
...
void SingleGameState::updateWorld()
{

}

void SingleGameState::updateCollision()
{
...
void SingleGameState::updateplBullets()
{
	unsigned counter = 0;
...
void SingleGameState::updateckBullet()
{
	unsigned counter = 0;
...
void SingleGameState::updateCheckens()
{
	//Spawning
...
void SingleGameState::updateCombat()
{
...
void SingleGameState::update(const float& dt)
{
	this->updateKeybinds();
	this->updateText();
...
void SingleGameState::renderGUI()
{
...
void SingleGameState::renderWorld()
{
	this->window->draw(this->worldBackground);
}

void SingleGameState::render(sf::RenderTarget* target)
{
	if (!target)
		target = this->window;
